...
\begin{center}
    ...
    Stromdichtevektor \(\hat{j}\)       & \(\Leftrightarrow \) & Wirbelstärkevektor \(\vec{\omega}\)\\ % Dieser Zusammenhang wird hier nicht explizit verwendet aber veranschaulicht den Zusammenhang besser als die Zirkulation
...
\input{papers/wirbelringe/fig/ausbreitung_teilchen.tex}
