...
Nimmt man jetzt jeweils einen Punkt auf der Oberseite sowie einen auf der Unterseite und setzen diese in \eqref{paper:Wirbelringe:eq:Bernoulli} ein, so können sie 
\begin{equation*}
...
Deshalb finden die Airlines es grundsätzlich nicht sehr amüsant, zwei gewaltige Wirbelschleppen hinter ihren Flugzeugen herzuziehen, auch wenn es bei schlechtem Wetter sehr spektakulär aussehen kann (siehe \ref{buch:papers:Wirbelringe:fig:visualisierung_einer_wirbelschleppe}). 
