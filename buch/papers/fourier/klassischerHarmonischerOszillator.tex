...
In diesem Unterkapitel wird die Energie eines ungedämpften Federpendels näher untersucht.  
Im folgenden Kapitel~\ref{fourier:section:quantenfeldtheorie} wird der harmonische Oszillator dann im Rahmen der Quantenfeldtheorie betrachtet.
...
\input{papers/fourier/fig/fig-federpendel.tex}