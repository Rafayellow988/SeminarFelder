...
In der Grafik sieht man, dass die brechnete Frequanz nicht ganz mit der Dominanten Frequenz der Simulation übereinstimmt.
...
\begin{figure}
    ...
    \caption{Verlauf der Simulation (Links nach Rechts) der Reaktions-Diffusiongleichung mit Lotak-Volterra Modell(\ref{reaktdiff:equation:lvsys}) als Reaktionsterm. Die erste Grafik zeigt den Anfangszustand. Die Oszilation ist in den Grafiken 2 und 3 angedeutet jedoch schwer mit statischen Bilder darzustellen.}
