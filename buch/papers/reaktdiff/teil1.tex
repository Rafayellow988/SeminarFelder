...
Ein Beispiel ist in \ref{reaktdiff:fig:ownreakterm} zu sehen.
\begin{figure}
    \centering
...
Ein Beispiel kann in \ref{reaktdiff:fig:fhn} gsehen werden
\begin{figure}
    \centering
    ...
    \caption{Verlauf der Simulation (Links nach Rechts) der Reaktions-Diffusiongleichung mit FitzHugh-Nagumo Modell(\ref{reaktdiff:equ:fhn}) als Reaktionsterm}
...
Ein Beispiel ist in \ref{reaktdiff:fig:gs} zu sehen.
\begin{figure}
    \centering
