...
% Sie stellt eine Parabel dar, die nach oben geöffnet ist, da der Koeffizient \(D_u D_v > 0\) ist.  
...
\subsubsection{Aktivator-Inhibitor System}
...
\begin{figure}
    ...
    \caption{FFT der Animation. Die rote Linie zeigt die theortische minimale Frequnez von \(f = k_{\min} / 2 \pi \approx 0.109\). Man sieht das die dominanten Frequenzen links des berechneten Minimums ist.}
