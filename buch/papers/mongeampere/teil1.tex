...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.95\textwidth]{papers/mongeampere/fig/schnitt.pdf}
  \end{center}
  \caption{Schnittkurve auf einem Ellipsoid. Der violette Tangentialvektor und die Flächennormale spannen eine Ebene, 
  dessen Schnitt mit der Fläche die rote Schnittkurve ergibt.}\label{mongeampere:fig:schnitt}
\end{figure}
In Abbildung \ref{mongeampere:fig:schnitt} ist ein Beispiel einer solchen Schnittkurve zu sehen.
Die Schnittkurve ist nur von der Richtung des Tangentialvektors abhängig, welche durch $d u$ und $d v$ charakterisiert wird.
