...
\begin{tikzpicture}[>=latex,thick]
	...
	\begin{scope}[xshift=-4.2cm]
		...
		\node at (-0.05,0) {\includegraphics[width=4.8cm]{papers/mongeampere/fig/ellip.pdf}};
		%\draw[color=red] ({-\h},{-\l}) rectangle (\h,\l);
		\node at (0,-2.36) {(a)};
	\end{scope}
	\begin{scope}
		\clip ({-\h},{-\l-0.7}) rectangle (\h,\l);
		\node at (-0.15,0) {\includegraphics[width=4.8cm]{papers/mongeampere/fig/saddle.pdf}};
		%\draw[color=red] ({-\h},{-\l}) rectangle ({\h},\l);
		\node at (0,-2.36) {(b)};
	\end{scope}
	\begin{scope}[xshift=4.2cm]
		\clip ({-\h},{-\l-0.7}) rectangle (\h,\l);
		\node at (0.05,0) {\includegraphics[width=5.0cm]{papers/mongeampere/fig/para.pdf}};
		%\draw[color=red] ({-\h},{-\l}) rectangle (\h,\l);
		\node at (0,-2.36) {(c)};
	\end{scope}
\end{tikzpicture}
