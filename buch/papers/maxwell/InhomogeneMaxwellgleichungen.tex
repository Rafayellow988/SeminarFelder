...
\subsection{Berechnung von $\ast d \ast F$}
...
Der erste Term muss, wegen dem Gaussschen Gesetzt der Elektrostatik, 
\begin{equation*}
...
\end{equation}
In koordinatenfreier Sprache mit $dx^0 = cdt, dx^1 = dx,dx^2=dy$ und $dx^3 = dz$ entspricht dies
\begin{equation}
