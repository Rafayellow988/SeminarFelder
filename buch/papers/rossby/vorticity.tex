...
Die planetare Vorticity wird durch den sogenannten \emph{Coriolis-Parameter} \(
...
Die \emph{potenzielle Vorticity} (PV) erweitert das Konzept der \emph{absoluten
...
Die PV-Erhaltung erklärt viele grossskalige atmosphärische Phänomene: Wird ein
Luftpaket nach Norden transportiert (höheres \(f\)), so muss es zyklonale
