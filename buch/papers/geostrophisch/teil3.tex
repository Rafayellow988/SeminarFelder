...
Das Programm bezieht die Daten der Atmosphäre von einer Internet Seite namens OpenWeatherMap.
Als erstes habe ich eine Liste mit den Städten und dazugehörigen Koordinaten, der Orte die ich auf der Karte gerne angezeigt haben möchte.
Anschliessend werden von allen Ortschaften die Druckdaten von der Internetseite gelesen.
Danach wird ein Gitter mit den Koordinaten der Ortschaften erstellt, indem zuerst die Längen- und Breitengrade vom kleinsten bis zum grössten Wert in konstante Schritte aufgeteilt werden.
Danach wird für jeden Punkt im Gitter der Luftdruck interpoliert.

Nachfolgen mein Python Code zum Programm
\lstinputlisting{papers/geostrophisch/PythonCode/geostrophischeNaeherungLiveData.py}
