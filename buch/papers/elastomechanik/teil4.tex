...
Der Oedometerversuch dient zur Bestimmung der Verformungseigenschaften von Böden unter einaxialer Belastung. Dabei wird eine zylindrische Bodenprobe in einer starren Form seitlich eingespannt, sodass keine laterale Dehnung stattfinden kann (\( \varepsilon_x = \varepsilon_y = 0 \)). Auf die Probe wird schrittweise eine vertikale Spannung \( \sigma_z \) aufgebracht, während die vertikale Verformung \( \Delta h \) gemessen wird.
...
Dieser Wert beschreibt die Steifigkeit des Bodens unter einaxialer Belastung. In der Praxis liegt \( E_o \) für Kiese im Bereich von \( 10^4 \)–\( 10^5 \,\si{\kilo\pascal} \), für Sande bei \( 10^3 \)–\( 10^4 \,\si{\kilo\pascal} \), und für Tone oft deutlich darunter. Das Ergebnis ist somit typisch für einen verdichteten sandigen Boden.
\end{document}
