...
Eine positive Fläche ist generell einer Rotation \emph{im Uhrzeigersinn}
zuzuordnen, eine negative Fläche bedeutet eine Rotation im \emph{Gegenuhrzeigersinn}.
...
\begin{equation}
  \begin{aligned}
    \mathbf{a} &= \begin{pmatrix} 3 \\ 1 \end{pmatrix} = 3 \mathbf{e_1} + \mathbf{e_2} \\
    \mathbf{b} &= \begin{pmatrix} 1 \\ 2 \end{pmatrix} = \mathbf{e_1} + 2 \mathbf{e_2} \\
  \end{aligned}
\end{equation}
.
...
\begin{equation}
  \begin{aligned}
    \mathbf{a} \wedge \mathbf{b} &= (3 \mathbf{e_1} + \mathbf{e_2}) \wedge (\mathbf{e_1} + 2 \mathbf{e_2}) \\
    &= 5 \mathbf{e_1} \wedge \mathbf{e_2}
  \end{aligned}
\end{equation}
. Die Fläche im aufgespannten Parallelogramm ist 5 und im Gegenuhrzeigersinn rotiert.
