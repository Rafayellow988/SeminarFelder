...
\begin{figure} %TODO change example
    \centering
    \input{papers/poinbendix/images/nullklinen.tikz}
    \caption{Die Nullklinen unterteilen die Ebene in 4 Quadranten mit unterschiedlicher Flussrichtung.}
