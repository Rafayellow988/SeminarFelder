...
\begin{scope}
\clip (0,0) rectangle({\bogenbreite},{0.47*\bogenhoehe});
...
\node at ({0.75*\bogenbreite},8.0)
	{\includegraphics[width=33cm]{frontimage.jpg}};
\end{scope}

\begin{scope}
\clip (0,0) -- ({0.5*\bogenbreite},0) -- ++(0,{0.5*\bogenhoehe}) -- (0,{0.5*\bogenhoehe}) -- cycle;
\node at ({0.25*\bogenbreite},8.0)
	{\includegraphics[width=33cm]{backimage.jpg}};
\end{scope}
