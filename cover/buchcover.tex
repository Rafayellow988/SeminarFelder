...
\begin{scope}
\clip (0,0) -- ({0.5*\bogenbreite},0) -- ++(0,{0.5*\bogenhoehe})
	-- (0,{0.5*\bogenhoehe}) -- cycle;
\node at ({0.22*\bogenbreite},8.3)
	{\includegraphics[width=38cm]{backimage.jpg}};
\end{scope}
...
des Windes auf 5m Höhe über Grund bei Ostwind, auf der Rückseite wurde
mit einer Westströmung gerechnet.
